//PRÁTICA 3
//● Na pasta src/controller crie o arquivo AccountController.ts
//● Crie a classe AccountController
//● Transforme o callback do endpoint PUT accounts/:id/balance em um método da classe e refatore o index.ts
...
export class AccountController {
    ...
    public balanceByIdAccount = async (req: Request, res: Response) => {
        try {
